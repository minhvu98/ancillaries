...
<section class="content">
	<form>
		<button type="submit" class="btn btn-primary"
			formaction="${pageContext.request.contextPath }/admin/warehouse/add">New Warehouse</button>
	</form>
									...
									<thead>
										<tr role="row">
											<th class="sorting_asc" tabindex="0" aria-controls="example2"
												...
												aria-label="Warehouse: activate to sort column descending">Warehouse</th>
									...
									<tbody>
										...
										<c:forEach var="warehouse" items="${warehouses }">
											<tr role="row" class="odd">
												...
												<td><form>
														<button type="submit" class="btn btn-primary"
															formaction="${pageContext.request.contextPath }/admin/warehouse/edit/${warehouse.id}">Update</button>
													</form></td>
